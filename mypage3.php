...
// $username=$_SESSION["username"]; //login_actのセッション変数のところの名前と合わせる
// var_dump($id);
// exit();
$username="yumie";
// $user_id=$_["user_id"];
...
// データベースにデータがあるか
$sql = 'SELECT * FROM kqfm_news_table'; 
// WHERE news_username=:username AND news_is_deleted=0';
// var_dump($sql);
// exit();
...
if ($status == false) {
  ...
  foreach ($result as $record) {
    $output .= "<tr>";
    $output .= "<td>{$record["news_title"]}</td>";
